                ...
                <div class="col-12 text-center">
                    <div class="breadcrumb-content position-relative section-content">
                        ...
                        <ul>
                            ...
                            <li style="color:red;">Flower arrangements</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<section class="products">
   <div class="box-container">
    ...
    <?php
         $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'Flower Arrangements'") or die('query failed');
